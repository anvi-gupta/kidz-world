...
function updatePrice(){
    ...
    book1.quantity*book1.dollar*100+book1.quantity*book1.cents;
    var book2CostInCents=
    book2.quantity*book2.dollar*100+book2.quantity*book2.cents;
    var book3CostInCents=
    book3.quantity*book3.dollar*100+book3.quantity*book3.cents;
    var book4CostInCents=
    book4.quantity*book4.dollar*100+book4.quantity*book4.cents;
    var book5CostInCents=
    book5.quantity*book5.dollar*100+book5.quantity*book5.cents;
    var book6CostInCents=
    book6.quantity*book6.dollar*100+book6.quantity*book6.cents;
    var book1CostInCents=
    book1.quantity*book1.dollar*100+book1.quantity*book1.cents;

    var game1CostInCents=
    game1.quantity*game1.dollar*100+game1.quantity*game1.cents;
    var game2CostInCents=
    game2.quantity*game2.dollar*100+game2.quantity*game2.cents;
    var game3CostInCents=
    game3.quantity*game3.dollar*100+game3.quantity*game3.cents;
    var game4CostInCents=
    game4.quantity*game4.dollar*100+game4.quantity*game4.cents;

    var craft1CostInCents=
    craft1.quantity*craft1.dollar*100+craft1.quantity*craft1.cents;
    var craft2CostInCents=
    craft2.quantity*craft2.dollar*100+craft2.quantity*craft2.cents;
    var craft3CostInCents=
    craft3.quantity*craft3.dollar*100+craft3.quantity*craft3.cents;
    var craft4CostInCents=
    craft4.quantity*craft4.dollar*100+craft4.quantity*craft4.cents;
